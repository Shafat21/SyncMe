	...
	async run(bot, message, settings) {
		...
		for (let i = 0; i < pagesNum; i++) {
			...
			const embed = new Embed(bot, message.guild)
				...
				.addField(`<:greendot:900352597528051752> How to Listen to Previous Music`, `<:greendot:900352597528051752> Use ${settings.prefix}back to listen to Previous song`, true)
