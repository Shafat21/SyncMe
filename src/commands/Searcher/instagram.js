	...
	*/
	async callback(bot, interaction, guild, args) {
		...
		if (typeof (res) == 'object') {
			...
			interaction.reply({ embeds: [channel.error(res, {}, true)], ephemeral: true });
		}
	}
	...
	*/
	async createEmbed(bot, username, guild) {
		...
		return new Embed(bot, guild)
			...
			.addField(guild.translate('searcher/instagram:PRIVATE'), account.is_private ? '<:icons_locked:861852633193906177> Yes' : '<:icons_unlock:861864835778871297> No', true)
			.addField(guild.translate('searcher/instagram:VERIFIED'), account.is_verified ? '<:icons_Correct:859388130411282442> Yes' : '<:icons_Wrong:859388130636988436> No', true);
	}
}
