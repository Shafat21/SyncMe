  ...
  */
	constructor(bot) {
		super(bot, {
			...
			guildOnly: true,
			dirname: __dirname,
			aliases: ['serverinfo', 'guildinfo', 'srinfo'],
	...
	async createEmbed(bot, guild, user) {
		...
		return new Embed(bot, guild)
			...
			.addFields(
				...
				{ name: guild.translate('guild/server-info:MEMBER'), value: guild.translate('guild/server-info:MEMBER_DESC', { NUM: guild.memberCount,
				...
				{ name: guild.translate('guild/server-info:JOIN'), value: moment(member.joinedAt).format('lll'), inline: true },
